...
func TestParseFile(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		if cfg.StartPeriod != tc.expected.StartPeriod {
			t.Errorf(
				"got %v for start period but wanted %v",
				cfg.StartPeriod,
				tc.expected.StartPeriod,
			)
		}
		...
		if cfg.Cashflows[0].Name != tc.expected.Cashflows[0].Name {
			t.Errorf(
				"got %v for name of first cashflow %v",
				cfg.Cashflows[0].Name,
				tc.expected.Cashflows[0].Name,
			)
		}
		if cfg.Cashflows[0].IsOutflow != tc.expected.Cashflows[0].IsOutflow {
			t.Errorf(
				"got %v for isOutflow of first cashflow; expected %v",
				cfg.Cashflows[0].IsOutflow,
				tc.expected.Cashflows[0].IsOutflow,
			)
		}
		if cfg.Cashflows[0].Periods != tc.expected.Cashflows[0].Periods {
			t.Errorf(
				"got %v for periods of first cashflow; expected %v",
				cfg.Cashflows[0].Periods,
				tc.expected.Cashflows[0].Periods,
			)
		}
		...
		if cfg.Cashflows[1].Name != tc.expected.Cashflows[1].Name {
			t.Errorf(
				"got %v for name of second cashflow %v",
				cfg.Cashflows[1].Name,
				tc.expected.Cashflows[1].Name,
			)
		}
		if cfg.Cashflows[1].IsOutflow != tc.expected.Cashflows[1].IsOutflow {
			t.Errorf(
				"got %v for isOutflow of second cashflow %v",
				cfg.Cashflows[1].IsOutflow,
				tc.expected.Cashflows[1].IsOutflow,
			)
		}
		if cfg.Cashflows[1].Periods != tc.expected.Cashflows[1].Periods {
			t.Errorf(
				"got %v for periods of second cashflow; expected %v",
				cfg.Cashflows[1].Periods,
				tc.expected.Cashflows[1].Periods,
			)
		}
		...
		if cfg.Cashflows[2].Name != tc.expected.Cashflows[2].Name {
			t.Errorf(
				"got %v for name of third cashflow %v",
				cfg.Cashflows[2].Name,
				tc.expected.Cashflows[2].Name,
			)
		}
		if cfg.Cashflows[2].IsOutflow != tc.expected.Cashflows[2].IsOutflow {
			t.Errorf(
				"got %v for isOutflow of third cashflow %v",
				cfg.Cashflows[2].IsOutflow,
				tc.expected.Cashflows[2].IsOutflow,
			)
		}
		if cfg.Cashflows[2].Periods != tc.expected.Cashflows[2].Periods {
			t.Errorf(
				"got %v for periods of third cashflow; expected %v",
				cfg.Cashflows[2].Periods,
				tc.expected.Cashflows[2].Periods,
			)
		}
